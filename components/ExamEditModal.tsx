    ...
    return (
        <>
            <Modal isOpen={isOpen} onClose={onClose} title={`Modifica Esame: ${exam.description}`}>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex justify-between items-center pt-4 border-t border-slate-200 dark:border-slate-700">
                        <button type="button" onClick={() => setIsConfirmingDelete(true)} className="px-4 py-2 text-base font-medium text-red-600 bg-red-100 rounded-md hover:bg-red-200 dark:bg-red-900/50 dark:text-red-300 dark:hover:bg-red-900/80">Elimina Esame</button>
            ...
            <ConfirmationModal
                ...
                message={`Sei sicuro di voler eliminare l'esame "${exam.description}"?`}
