...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-slate-200 z-20 dark:bg-slate-900/80 dark:border-slate-700">
            <div className="mx-auto px-4 sm:px-6 lg:px-8 h-12 flex items-center justify-between text-sm text-slate-500 dark:text-slate-400">
                ...
                <div className="flex-1 text-center font-semibold text-base text-slate-700 dark:text-slate-200">
